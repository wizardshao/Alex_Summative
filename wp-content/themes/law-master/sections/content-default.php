...
?>
 ...
 <section class="pb_cover_v1 text-left cover-bg-black cover-bg-opacity-4" style="background-image: url(<?php echo get_bloginfo('template_directory');?>/assets/images/1900x1200_img_7.jpg)" id="section-home">
      <div class="container">
